...
urlpatterns = [
    ...
    path('appointments/<str:appointment_id>/', AppointmentProxyView.as_view(), name='appointment_detail_proxy'),
    path('patients/', PatientProxyView.as_view(), name='patients_proxy'),
    path('patients/<str:patient_id>/', PatientProxyView.as_view(), name='patient_detail_proxy'),
    path('doctors/', DoctorProxyView.as_view(), name='doctors_proxy'),
    path('doctors/<str:doctor_id>/', DoctorProxyView.as_view(), name='doctor_detail_proxy'),
